...
QrScannerComponent.ɵfac = function QrScannerComponent_Factory(t) { return new (t || QrScannerComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2)); };
QrScannerComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: QrScannerComponent, selectors: [["qr-scanner"]], viewQuery: function QrScannerComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [ɵngcc1.NgSwitch, ɵngcc1.NgSwitchDefault, ɵngcc1.NgSwitchCase], styles: ["[_nghost-%COMP%]   video[_ngcontent-%COMP%] {height: auto; width: 100%;}", "[_nghost-%COMP%]   .mirrored[_ngcontent-%COMP%] { transform: rotateY(180deg); -webkit-transform:rotateY(180deg); -moz-transform:rotateY(180deg); }", "[_nghost-%COMP%] {}"] });
/** @nocollapse */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(QrScannerComponent, [{
        type: Component,
        args: [{
                selector: 'qr-scanner',
                styles: [
    ...
    }], function () { return [{ type: ɵngcc0.Renderer2 }]; }, { canvasWidth: [{
            type: Input
        }], canvasHeight: [{
            type: Input
        }], debug: [{
...
NgQrScannerModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: NgQrScannerModule });
NgQrScannerModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[
            CommonModule
        ]] });
/** @nocollapse */
NgQrScannerModule.ctorParameters = () => [];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgQrScannerModule, [{
        type: NgModule,
        args: [{
                imports: [
                    CommonModule
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgQrScannerModule, { declarations: function () { return [QrScannerComponent]; }, imports: function () { return [CommonModule]; }, exports: function () { return [QrScannerComponent]; } }); })();
